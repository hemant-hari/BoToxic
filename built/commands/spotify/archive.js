    ...
    execute: function (msg, args, api) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                archiveChannel = msg.mentions.channels.first();
                if (msg.content.includes("disable")) {
                    guildconfig_1.setArchive(msg.guild.id, null, false);
                    msg.channel.send("Spotify archiving disabled.");
                    return [2 /*return*/];
                }
                if (archiveChannel.type === "text") {
                    guildconfig_1.setArchive(msg.guild.id, archiveChannel.id, true)
                        .then(function () { return msg.channel.send("Spotify shares will now be archived to the mentioned channel after 1 hour."); })
                        .catch(function (err) {
                        console.log(err);
